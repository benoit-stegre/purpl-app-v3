...
interface ExplanationCourteInlineEditorProps {
  designConfig: DesignConfigV6
  onUpdate: (updates: Partial<DesignConfigV6>) => void
}

export default function ExplanationCourteInlineEditor({
  designConfig,
  onUpdate
}: ExplanationCourteInlineEditorProps) {
  ...
  // Ajouter couleurs à la palette à la fermeture du panel
  useEffect(() => {
